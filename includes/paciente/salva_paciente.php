...
require_once('conecta.php');
    ...
    if ($total>0){
        ?>
        <script>
            alert("Este cpf já possui cadastro! Caso necessário clique em 'Esqueceu sua senha' ou entre em contato com o administrador");
            window.close();
        </script>
        <?php
        exit();
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<a href='/index.php'><input type='button' value='Entrar'></a></center>";
    } else {
