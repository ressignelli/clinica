...
<body>
            ...
            <form>
            <div id="div1">
            <h4>Termo de Consentimento e Contrato de Serviço:</h4>
            <textarea readonly name="area" id="area" style="width:50%;height:100px;">
                
Termo de Consentimento para Tratamento de Dados Pessoais e Prestação de Serviços Médicos
...
Ao aceitar o presente termo, o Titular consente e concorda que Dr. José Augusto Ressignelli de Lima, CRM 151.901 (controlador), tome decisões referentes ao tratamento de seus dados pessoais, bem como realize o tratamento de seus dados pessoais, envolvendo operações como as que se referem a coleta, produção, recepção, classificação, utilização, acesso, reprodução, transmissão, distribuição, processamento, arquivamento, armazenamento, eliminação, avaliação ou controle da informação, modificação, comunicação, transferência, difusão ou extração.
...
- Números de telefone, nº celular/ whatsApp e endereços de e-mail;
- Endereço residencial;
- Sexo, etnia e religião;
...
O Titular poderá solicitar via e-mail ao Controlador, a qualquer momento, que sejam eliminados os dados pessoais não anonimizados do Titular, respeitando os dados de uso profissional. O Titular fica ciente de que poderá ser inviável ao Controlador continuar o fornecimento de produtos ou serviços ao Titular a partir da eliminação dos dados pessoais.
...
O Usuário, Paciente ou Cliente concorda com os termos de Prestação de Serviço Médico contratados ao Dr. José Augusto Ressignelli de Lima, CRM 151.901, sendo eles:
1. A veracidade das informações prestadas neste cadastro é de total responsabilidade do usuário;
1.1. O dia, hora e IP da origem será gravada junto ao cadastro para identificação caso seja necessário;
2. A Emissão de Nota Fiscal e do Informe de Rendimento do Ano são enviados por e-mail cadastrado pelo cliente, automaticamente, e para segurança terão o acesso restrito por senha (4 primeiros digitos do cpf do cliente);
3. É permitido 1 retorno de consulta a cada 30 dias (sem custos adicionais), mediante disponibilidade de horário para agendamento;
3.1. O médico responsável pelo paciente poderá aumentar o retorno neste período, sendo o paciente comunicado e sem custos adicionais;
4. A solicitação de cópia de prontuário médico deverá ser solicitada, mediante preenchimento de termo, presencialmente na instituição do médico, pelo paciente ou o seu representante legal (devidamente documentado);
4.1 O prazo é 7 dias corridos para confecção;
4.2 Caso autorizado pelo cliente, o documento poderá ser enviado por meio eletrônico de e-mail;
4.3 Documento será em arquivo .pdf com senha (4 primeiros dígitos do cpf do cliente);
5. Através dos aplicativos on-line, o usuário poderá solicitar 2ª via de receita médica, de atestado médico e/ou relatório médico, previamente redigidos em consulta anterior;
5.1 Caso a solicitação seja referente a 2ª via de receitas, atestados e/ou relatórios médicos anteriores ao da última consulta, deverá seguir o item 4;
6. É intransferível para outra pessoa a consulta agendada por ela;
7. A devolução de valor previamente pago, somente ocorrerá após o cancelamento de consulta;
7.1 Neste caso ocorrerá a devoluçãp em até 2 dias úteis;
8. É de total responsabilidade do paciente quanto ao uso correto das medicações e orientações médicas.

TERMO DE CONSENTIMENTO PARA TELECONSULTA DO PACIENTE

Este Termo de consentimento do paciente é composto de descrição técnica das etapas de atendimento do paciente e sua concordância, bem como das normas de segurança para uso da Teleconsulta na Telemedicina.
Declaro de minha livre escolha que a realização de uma teleconsulta pode ser feita por videoconferência, através do médico DR. JOSÉ AUGUSTO RESSIGNELLI DE LIMA.
...
ENTENDO AINDA QUE NESTE TERMOS DE CONSENTIMENTO DO PACIENTE 
...
ATESTADOS MÉDICOS QUE PODEM SER EMITIDOS POR TELECONSULTA:
...
IMPORTANTE: O MÉDICO TEM TOTAL AUTONOMIA PARA DETERMINAR SE CONSIDERA QUE O PACIENTE NECESSITA OU NÃO DE ATESTADO OU MEDICAMENTO.
 
DECLARAÇÃO DO TERMOS DE CONSENTIMENTO DO PACIENTE
...
3.	que o envio deste termo não significa necessariamente atendimento imediato. O dia e horário para o atendimento por telemedicina deverão ser acordada entre as partes conforme disponibilidade de agenda do médico e meios de comunicação disponíveis.
